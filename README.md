...
Generated by **UI/UX Pro Max** skill (`design-system/racedb/MASTER.md`):

- **Style**: Dark Mode OLED + Cinema Dark glassmorphism
- **Font**: Inter (variable weight)
- **Accent**: `#22C55E` (neon green) + `#3B82F6` (electric blue)
- **Background**: `#080D1A` → `#0F172A`
